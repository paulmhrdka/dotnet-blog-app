...
export class BlogItemsClient implements IBlogItemsClient {
...
export class CreateBlogItemCommand implements ICreateBlogItemCommand {
    title?: string | undefined;
    content?: string | undefined;

    constructor(data?: ICreateBlogItemCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateBlogItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateBlogItemCommand();
        result.init(data);
        return result;
    }
